...
def show_welcome_page(root):
    ...
    welcome_label = tk.Label(welcome_frame, text="Willkommen zum Netscape Navigator OS V.0.6 Beta 1, Workstation Edition Setup", bg="darkblue", fg="yellow", font=("Arial", 22, "bold"))
...
def start_installation(root, base_dir):
    ...
    desktop_path = r"C:/Users/User/Desktop/Netscape Navigator OS V.0.6 Beta 1-Workstation.pyw"
    onedrive_path = r"C:/Users/User/OneDrive/Desktop/Netscape Navigator OS V.0.6 Beta 1-Workstation.pyw"
